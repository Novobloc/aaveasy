              ...
              <Menu as="div" className="relative">
                ...
                <Transition
                  ...
                  <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <Menu.Item>
                      {({ active }) => (
                        <Link to="/wallet" className={classNames(active ? "bg-gray-100" : "", "px-4 py-2 text-sm text-gray-700 flex")}>
                          <UserCircleIcon height={18} className="mt-1" />
                          <span className="ml-3 mt-1">My Wallet</span>
                        </Link>
                      )}
                    </Menu.Item>
                    <Menu.Item>
